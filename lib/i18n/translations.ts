...
const fa = {
  ...
  "privacy.dataCollected.body": "اگر از فرم تماس با ما استفاده کنید، نام، آدرس ایمیل و پیام شما را جمع‌آوری می‌کنیم — این اطلاعات از طریق EmailJS به ایمیل مدیر سایت ارسال می‌شود. اگر اعلان‌های پوش را فعال کنید، OneSignal یک اشتراک روی دستگاه شما ایجاد می‌کند تا بتوانیم اعلان‌های اختیاری برایتان ارسال کنیم. زبان انتخابی شما فقط در حافظه محلی مرورگرتان ذخیره می‌شود و به هیچ‌جا ارسال نمی‌شود. اگر بنر کوکی ما را بپذیرید، از Google Analytics برای درک نحوه استفاده بازدیدکنندگان از سایت (صفحات بازدیدشده، دکمه‌های کلیک‌شده) استفاده می‌کنیم — این اطلاعات ناشناس است و فقط پس از رضایت شما فعال می‌شود.",
...
const en: Dictionary = {
  ...
  "privacy.dataCollected.body": "If you use our contact form, we collect your name, email address, and message — sent via EmailJS to the site owner's inbox. If you enable push notifications, OneSignal creates a subscription on your device so we can send you optional alerts. Your language preference is stored in your browser's local storage, not sent anywhere. If you accept our cookie notice, we use Google Analytics to understand how visitors use the site (pages viewed, buttons clicked) — this is anonymized and only active after you consent.",
